...
{
    /// <inheritdoc />
    public partial class UpdatePaymentAndTransactionRelationships : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppRatings", x => x.RatingId);
                    table.ForeignKey(
                        name: "FK_AppRatings_Users_SSN",
                        column: x => x.SSN,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_Users_SSN",
                        column: x => x.SSN,
                        principalTable: "Users",
                        principalColumn: "SSN",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favourites_SSN",
                table: "Favourites",
                column: "SSN");

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_SSN",
                table: "Notifications",
                column: "SSN");
