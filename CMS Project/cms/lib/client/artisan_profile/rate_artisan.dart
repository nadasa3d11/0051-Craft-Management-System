...
class RateArtisanPage extends StatefulWidget {
  final String artisanSSN;

  const RateArtisanPage({super.key, required this.artisanSSN});

  @override
  _RateArtisanPageState createState() => _RateArtisanPageState();
}

class _RateArtisanPageState extends State<RateArtisanPage> {
  ...
  void initState() {
    ...
    if (widget.artisanSSN.isEmpty) {
      setState(() {
        _errorMessage = 'Invalid artisan SSN. Cannot submit rating.';
      });
    }
  }
  ...
  Future<void> _submitRating() async {
    ...
    try {
      await _apiService.submitArtisanRating(
        widget.artisanSSN,
        rating,
      ...
      await _showErrorDialog('You can\'t rate this artisan twice.');
    } finally {
      setState(() {
        _isRefreshing = false;
      });
                              ...
                              Container(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        'would you like to write anything about this Artisan?',
